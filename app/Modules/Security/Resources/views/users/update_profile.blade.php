...
@section('content')
    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-5 col-md-2">
                        <div class="nav flex-column nav-pills nav-secondary nav-pills-no-bd nav-pills-icons"
                            ...
                            <a class="nav-link active" data-bs-toggle="pill" href="#v-photo" role="tab"
                                aria-controls="v-pills-profile-icons" aria-selected="false" tabindex="-1">
                                <i class="fa fa-camera"></i>
                                {{__('Photo')}}
                            </a>
                            <a class="nav-link " data-bs-toggle="pill" href="#v-profile" role="tab"
                                aria-controls="v-pills-home-icons" aria-selected="true">
                                <i class="far fa-user"></i>
                                {{__('Profile')}}
                            </a>
                            <a class="nav-link" data-bs-toggle="pill" href="#v-password" role="tab"
                                aria-controls="v-pills-profile-icons" aria-selected="false" tabindex="-1">
                    ...
                    <div class="col-7 col-md-10">
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="v-photo" role="tabpanel"
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4">
                                        ...
                                        <div class="card card-post card-round">
                                            <div class="p-4 text-center">
                                                {!! renderAvatar(Auth::user(), 'avatar-xxl', 'mx-auto') !!}
                                            </div>
                                            <div class="card-body">
                                                <div class="d-flex">
                                                ...
                                                <a href="javascript:void(0)" onClick="$('#panelVideo').slideDown('fast')"
                                    ...
                                    <div id="panelVideo" style="display:none" class="col-12 col-md-6 col-lg-8">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-4 col-lg-4 col-stats">
                                                    <a href="javascript:void(0)" onClick="$('#file_photo').click()"
                                                        class="btn btn-primary btn-rounded btn-xl">
                                                        <li class="fa  fa-desktop"></li>
                                                        {{__('Upload the computer')}}
                                                    </a>
                                                </div>
                                                <div class="col-12 col-md-4 col-lg-4 col-stats">
                                                    <a href="javascript:void(0)" id="setCam"
                                                        class="btn btn-primary btn-rounded btn-xl">
                                            ...
                                            <div style="display:none" id="cardPhoto" class="row mt-3 ">
                                                <div class="card">
                                                    <div class="card-body text-center">
                                                        <img class="card-img-top" style="height: 400px; width: 550px"
                                                            id="new_photo" src="#" alt="New Image" />
                                                        <div class="row mt-3">
                                                            <div class="col-12 col-md-6 col-lg-4 offset-lg-4 offset-md-3">
                                                                <button id="photoSave" type="button"
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="form-floating form-floating-custom mb-2">
                                            {{html()->select("type_document", $typeDoc, Auth::user()->documentType?->crypt_id)
        ->class('form-select')
        ...
        ->required(true)
                                        ...
                                        @error('type_document')
                                            <label id="type_document-error" class="error"
                                                for="type_document">{{__('This field is required')}}</label>
                                        @enderror
                                        <div class="form-floating form-floating-custom mb-2">
                                            {{
        html()->input("text", 'document', Auth::user()->document)
            ...
            ->required(true)
                                        ...
                                        @error('document')
                                            <label id="document-error" class="error"
                                                for="document">{{__('This field is required')}}</label>
                                        @enderror
                                        <div class="form-floating form-floating-custom mb-2">
                                            {{
            ...
            ->required(true)
                                        ...
                                        @error('full_name')
                                            <label id="full_name-error" class="error"
                                                for="full_name">{{__('This field is required')}}</label>
                                        @enderror
                                        <div class="form-floating form-floating-custom mb-2">
                                            {{
            ...
            ->required(true)
                                        ...
                                        @error('phone')
                                            <label id="phone-error" class="error"
                                                for="phone">{{__('This field is required')}}</label>
                                        @enderror
                                        <div class="row">
                                            ...
                                            <div class="form-sub">
                                                ...
                                                <div class="form-floating form-floating-custom mb-2">
                                                    <input id="current_password" name="current_password" type="password"
                                                        maxlength="16" class="form-control" placeholder="" required />
                                                ...
                                                @error('password')
                                                    <label id="current_password-error" class="error"
                                                        for="current_password">{{__('This field is required')}}</label>
                                                @enderror
                                                <div class="form-floating form-floating-custom mb-2">
                                                ...
                                                @error('password')
                                                    <label id="new_password-error" class="error"
                                                        for="new_password">{{__('This field is required')}}</label>
                                                @enderror
                                                <div class="form-floating form-floating-custom mb-2">
                                                ...
                                                @error('password')
                                                    <label id="re_password-error" class="error"
                                                        for="re_password">{{__('This field is required')}}</label>
                                                @enderror
                                                <div class="row">
                                                    <button id="credentialsSave" type="button"
                                                        class="btn btn-large btn-info">
                                                        <i class="fa fa-save"></i>
                                                        {{__('Update')}}</button>
                                                </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalCamera" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true"
    ...
    <script type="text/javascript">
        ...
        document.addEventListener("DOMContentLoaded", function (event) {
            ...
            iti = window.intlTelInput(document.getElementById('phone'), {
                initialCountry: '{{Auth::user()->country?->iso2 ?? 'us'}}',
                //onPhoneNumberBlur
                //countryDialCode: '+58',
                strictMode: true,
