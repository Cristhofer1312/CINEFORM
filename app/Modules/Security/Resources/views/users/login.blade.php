...
@section('content')
    ...
    <div class="wrapper-login d-flex flex-column justify-content-center align-items-center py-5">
        <h1 class="display-4 fw-bold text-center mb-4 text-white" style="text-shadow: 0 2px 4px rgba(0,0,0,0.5);">Bienvenidos a CINEFORM</h1>
        <div class="container-login bg-white shadow-lg rounded-4 p-5 animated fadeIn">
            <div class="text-center mb-4">
                <img class="img-fluid mb-3" src="{{ asset('template/kaiadmin/assets/img/kaiadmin/logo.jpeg')}}" alt="Logo"
                ...
                <div class="login-form">
                    ...
                    <div class="form-sub">
                        ...
                        <div class="form-floating form-floating-custom mb-2">
                            <input id="username" name="username" maxlength="50" type="text" autofocus=""
                                class="form-control" placeholder="{{__('username')}}" required />
                        ...
                        @enderror
                        <div class="form-floating form-floating-custom mb-2">
                            <input id="captcha" name="captcha" maxlength="5" minlength="5" type="text"
                                style="text-transform: uppercase" class="form-control" placeholder="{{__('Captcha')}}"
                                required />
                        ...
                        <div class="row mt-4 align-items-center">
                            <div class="col-8">
                                <div class="border rounded p-1 bg-light text-center">
                                    <img id="img-c" class="img-fluid" src="{{ route('captcha', rand(1, 999)) }}"
                                        alt="captcha" style="max-height: 45px;">
                                </div>
                            </div>
                            <div class="col-4">
                                <button id="reload-img" type="button" class="btn btn-outline-primary w-100"
                    ...
                    <div class="login-account text-center">
                        ...
                        <a href="{{route('registro.usuario')}}" id="show-signup" class="text-primary fw-bold"
