...
<div class="row justify-content-center">
    <div class="col-lg-10">
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-1 p-0 bg-transparent" style="font-size: 0.8rem;">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('taller.cursos.index') }}" class="text-decoration-none text-muted">Programas</a></li>
                        <li class="breadcrumb-item active text-primary fw-bold">Paso 2: Requisitos</li>
                    </ol>
                </nav>
                <h2 class="fw-bold text-dark mb-0">Requisitos de la Actividad</h2>
                <p class="text-muted small mb-0"><i class="fas fa-list-check me-1 text-primary"></i> Configurando requisitos para: <strong>{{ $curso->nombre }}</strong></p>
            </div>
        </div>
        ...
        <form action="{{ route('taller.cursos.requisitos.store', $curso->id_curso) }}" method="POST">
            @csrf

            <div class="card border-0 shadow-card rounded-4 mb-5 overflow-hidden">
                <div class="card-header bg-white border-bottom py-3">
                    <h5 class="mb-0 fw-bold text-dark"><i class="fas fa-tasks text-primary me-2"></i> Formulario de Requisitos</h5>
                    <p class="text-muted small mb-0 mt-1">Añade preguntas a responder, recursos informativos o documentos que el participante deba subir obligatoriamente.</p>
                </div>
                <div class="card-body bg-light bg-opacity-50 p-4">
                    
                    <div id="requisitos-container">
                        <!-- Requisitos dinámicos aquí -->
                    </div>

                    <div class="text-center mt-5 mb-3">
                        <div class="dropdown d-inline-block">
                            <button class="btn btn-outline-primary border-2 px-4 py-2 rounded-pill fw-bold dropdown-toggle shadow-sm" type="button" id="btnAgregarRequisito" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="card border shadow rounded-pill overflow-hidden bg-white">
                        <div class="card-body p-2 d-flex align-items-center justify-content-between">
                            <a href="{{ route('taller.cursos.index') }}"
                                ...
                                onclick="return confirm('¿Saltar este paso? Podrás agregarlos luego editando el curso.')">
                                Saltar Paso
                            </a>
...
<script>
    ...
    function agregarRequisito(tipo, event) {
        ...
        if (tipo === 'pregunta') {
            ...
            // Recursos informativos no son obligatorios en sí mismos, desactivar o esconder switch
